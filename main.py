...
if __name__ == '__main__':
    ...
    trainer = ConvNEAT(output_size=10, n=10, torch_device=torch_device, name='test_5', seed=12)
    trainer.prompt(data_train, save_mode="elites", elitism_rate=0.2, min_species_size=4, epochs=3,
